...
app = FastAPI(
    title       = "审核专家 API 文档 RAG 问答",
    description = "基于《审核专家 API 接入文档》的混合检索问答服务",
    version     = "1.0.0",
    lifespan    = lifespan,
)
...
class QueryRequest(BaseModel):
    question: str            = Field(...,  example="审核专家 API 的鉴权方式是什么？")
    section:  Optional[str]  = Field(None, example="鉴权")
