...
3. 引用具体数据时，在句末标注来源文件名，如：违抗命令，遗弃武器装备的，处五年以下有期徒刑或者拘役；（来源：中华人民共和国刑法）
4. 数字要精确，回答简洁，重点突出"""
...
def main():
    parser = argparse.ArgumentParser(description="法律文档 RAG 问答（LangChain LCEL 版）")
    ...
    if args.query:
        ...
        print(f"法律文档 RAG 问答系统（LangChain LCEL 版）")
