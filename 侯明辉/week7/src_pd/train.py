...
与 cluener 版本的区别：
  ...
  2. 标签体系：7 个 BIO 标签（vs cluener 的 21 个）
  3. 输出目录：outputs_pd/（与 cluener 的 outputs/ 隔离）
  4. 其余训练逻辑完全相同：分层学习率 + Linear Warmup + 梯度累积
...
def main():
    ...
    print(f"数据集：人民日报 NER（3类实体：PER/ORG/LOC）")
