...
def gold_spans_from_record(record: dict) -> set[tuple[str, str, int, int]]:
    """从 peoples_daily 记录中提取 gold spans。"""
...
FEW_SHOT_EXAMPLES = [
    {
        "text": "钱其琛在厦门会见美国国务卿克里斯托弗",
        "output": '{"entities": [{"text": "钱其琛", "type": "PER"}, {"text": "厦门", "type": "LOC"}, {"text": "美国", "type": "LOC"}, {"text": "克里斯托弗", "type": "PER"}]}'
    },
    {
        "text": "全国人民代表大会澳门特别行政区筹备委员会在北京成立",
        "output": '{"entities": [{"text": "全国人民代表大会澳门特别行政区筹备委员会", "type": "ORG"}, {"text": "北京", "type": "LOC"}]}'
    },
    {
        "text": "沙特队主教练文加达赛后对记者说",
        "output": '{"entities": [{"text": "沙特队", "type": "ORG"}, {"text": "文加达", "type": "PER"}]}'
    },
]
