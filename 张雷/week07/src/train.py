...
预期输出（3 epochs）：
  ...
  ★ 新最优 F1=0.7910，已保存 → outputs/checkpoints/best_linear.pt
  ...
  ★ 新最优 F1=0.8020，已保存 → outputs/checkpoints/best_crf.pt

输出文件：
  outputs/checkpoints/best_linear.pt / best_crf.pt
  outputs/logs/train_linear.json / train_crf.json
"""
