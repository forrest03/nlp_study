...
REACT_SYSTEM = """你是联网研究助手，能用以下工具检索并核验公开信息。
...
class ReActLoop:
    ...
    def __init__(self, agent_name: str, tools: dict,
        ...
        observation_limit: 每轮回灌给模型的 Observation 字符上限，避免上下文失控。
        """
    ...
    def run(self, question: str, on_step: Callable = None,
        ...
        for step_idx in range(self.max_steps):
            ...
            # 续写历史
            history += llm_out + f"Observation: {observation[:self.observation_limit]}\n"
