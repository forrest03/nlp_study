...
def run(question: str, max_steps: int = 10, verbose: bool = True, history_messages: list = None) -> Generator[dict, None, None]:
    """
    ...
    参数：
      question: 用户问题
      max_steps: 最大步数
      verbose: 详细模式（已废弃，保留兼容）
      history_messages: 历史消息列表，用于多轮对话恢复
